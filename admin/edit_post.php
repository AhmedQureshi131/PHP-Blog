...
$post_id = $_GET['id'];
//Select data
$query4="SELECT * FROM posts WHERE id='$post_id'";
$post = $db->select($query4);
...
if(isset($_POST['update'])){
    ...
    if($title=='' || $content=='' || $author=='' || $tags=='' || $cats==''){
        ...
        $query3="UPDATE posts SET category='$cat', title='$title', content='$content', author='$author', tags='$tags' WHERE id='$post_id'";
        ...
        <div class="col-md-12 blog-main">
            <form action="edit_post.php?id=<?php echo $post_id;?>" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea name="content" class="form-control" row="3" placeholder="Enter Content"> <?php echo $single['content'];?> </textarea>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="author" class="form-control" id="inputEmail3" placeholder="Enter Author Name" value="<?php echo $single['author'];?>">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <div class="col-sm-10">
                        ...
                        <a href="delete.php?delete_id=<?php echo $post_id; ?>" class="btn btn-danger">Delete</a>
